...
def test_google_api():
    ...
    try:
        ...
        print(f"   ✅ Returns error message when API key missing")
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            mock_response.json.return_value = {
                'candidates': [{
                    'content': {
                        'parts': [{'text': 'Generated attack prompt'}]
                    }
                }]
            }
            ...
            print(f"   With mocked API:")
            print(f"     Result: {result2}")
            
            assert result2 == "Generated attack prompt", \
                "Should return generated text from API"
            print(f"   ✅ Google API integration works")
            
            # Check API call
            assert mock_post.called, "Should call requests.post"
            call_args = mock_post.call_args
            assert "generativelanguage.googleapis.com" in call_args[0][0] or \
                   "generativelanguage.googleapis.com" in str(call_args), \
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            print(f"   ✅ API error handling works")
...
def test_openai_api():
    ...
    try:
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            mock_response.json.return_value = {
                'choices': [{
                    'message': {'content': 'Generated attack prompt'}
                }]
            }
            mock_post.return_value = mock_response
            ...
            assert result2 == "Generated attack prompt", \
                "Should return generated text from API"
            print(f"   ✅ OpenAI API integration works")
            
            # Check API call
            assert mock_post.called, "Should call requests.post"
            call_args = mock_post.call_args
            assert "api.openai.com" in call_args[0][0] or \
                   "api.openai.com" in str(call_args), \
...
def test_flash_api():
    ...
    try:
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            assert result2 == "Generated attack prompt", \
                "Should return generated text from API"
            print(f"   ✅ Flash API integration works")
...
def test_error_handling():
    ...
    try:
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            print(f"   ✅ Timeout errors handled")
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            print(f"   ✅ Connection errors handled")
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            print(f"   ✅ Generic exceptions handled")
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            print(f"   ⚠️  ISSUE: May not handle JSON parsing errors gracefully")
    ...
    try:
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            if 'contents' in call_data:
                print(f"   ✅ Google API format correct")
                ...
                print(f"   ⚠️  Request format may not match Google API spec")
    ...
    try:
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            if timeout:
                ...
                print(f"   ✅ Timeout configured correctly (30 seconds)")
            else:
                print(f"   ⚠️  ISSUE: No timeout configured")
                print(f"   ⚠️  Expected: timeout=30 seconds")
                print(f"   ⚠️  Actual: No timeout parameter")
                print(f"   ⚠️  Impact: Requests may hang indefinitely")
...
def test_edge_cases():
    ...
    try:
        ...
        with patch('src.evil_agent.llm_client.requests.post') as mock_post:
            ...
            assert "API Error" in result or "400" in result, \
