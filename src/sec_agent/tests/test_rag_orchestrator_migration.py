...
from src.sec_agent.config import USE_REAL_VECTOR_RETRIEVAL
...
class TestRAGOrchestratorMigration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_prompt_template.format_messages.return_value = [{"role": "user", "content": "test"}]
    ...
    def test_uses_real_retrieval_when_flag_enabled(self, mock_mock_gen, mock_real_gen):
        ...
        mock_real_gen.return_value = [
            {"document_id": "doc-real-001", "retrieval_score": 0.85}
        ]
    ...
    def test_uses_mock_retrieval_when_flag_disabled(self, mock_mock_gen, mock_real_gen):
        ...
        mock_mock_gen.return_value = [
            {"document_id": "doc-mock-001", "retrieval_score": 0.9}
        ]
    ...
    def test_falls_back_to_mock_on_real_retrieval_error(self, mock_mock_gen, mock_real_gen):
        ...
        mock_mock_gen.return_value = [
            {"document_id": "doc-fallback-001", "retrieval_score": 0.8}
        ]
    ...
    def test_logs_migration_info_when_using_real_retrieval(self, mock_real_gen, mock_logger):
        ...
        self.assertTrue(migration_logged, "Migration logging should occur when using real retrieval")
    ...
    def test_logs_migration_info_when_using_mock_retrieval(self, mock_mock_gen, mock_logger):
        ...
        self.assertTrue(migration_logged, "Migration logging should occur when using mock retrieval")
