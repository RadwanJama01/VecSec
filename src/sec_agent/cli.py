...
from .config import create_rag_prompt_template, initialize_sample_documents, initialize_vector_store
...
def main():
    ...
    parser.add_argument(
        "--clearance", default="INTERNAL", help="Clearance level (default: INTERNAL)"
    )
    ...
    result = orchestrator.rag_with_rlsa(
        args.user_id, args.tenant_id, args.clearance, args.prompt, args.role
    )
