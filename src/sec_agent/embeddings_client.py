...
try:
    ...
    SentenceTransformerType = SentenceTransformer  # Type alias for type checking
except ImportError:
    SENTENCE_TRANSFORMERS_AVAILABLE = False
    SentenceTransformerType = None  # type: ignore[assignment]
...
class EmbeddingClient:
    ...
    def __init__(self, model_name: str = "all-MiniLM-L6-v2", batch_size: int = 32):
        ...
        self.embedding_cache: dict[int, np.ndarray] = {}  # Cache for embeddings
        self.total_calls = 0
        self.enabled = False
        ...
        if not SENTENCE_TRANSFORMERS_AVAILABLE:
            ...
            try:
                ...
                self.model: SentenceTransformerType | None = SentenceTransformer(model_name)  # type: ignore[assignment]
                self.enabled = True
                print("✅ Local embedding client initialized (runs offline, no API needed!)")
