...
from ai_agent import VecSecAgent, SecurityIncident, ThreatLevel, IncidentSeverity, AgentAction, DataClassification, DataType, AccessLevel
    ...
    test_data = [
        {
            ...
            "content": "John Smith, SSN: 123-45-6789, Email: john@company.com, Phone: (555) 123-4567",
            "metadata": {"department": "hr"}
        },
        {
            "name": "Financial Data", 
            "content": "Bank Account: 1234567890, Credit Card: 4532-1234-5678-9012, Balance: $50,000",
            "metadata": {"department": "finance"}
        },
        {
            "name": "Medical Records",
            "content": "Patient: Jane Doe, Diagnosis: Hypertension, Treatment: Lisinopril 10mg, Doctor: Dr. Smith",
            "metadata": {"department": "medical"}
        }
    ]
