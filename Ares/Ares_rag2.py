...
# Import google.generativeai for direct API access
...
# Configure the Google Generative AI library directly
genai.configure(api_key=GOOGLE_API_KEY)

# Create a wrapper class for compatibility with LangChain
class GoogleGenerativeAIWrapper:
    def __init__(self, model_name="gemini-1.5-flash", temperature=0.1):
...
llm = GoogleGenerativeAIWrapper(model_name="gemini-1.5-flash", temperature=0.1)
